                ...
                identify === "create" && (
                    <>
                        <div id='formPengabdian' className="flex p-4 mt-2 relative">
                            ...
                            <div className='w-3/4 relative'>
                                <input onChange={(e) => onHandleInput(e)} value={datas.nim} name="nim" type="number" className='w-full border-2 border-black px-2 py-1 pb-2 mt-1 rounded-md' />
                            </div>
                        </div>
                    </>
                )
                ...
                identify === "create" && (
                    <>
                        <div id='formPengabdian' className="flex p-4 mt-2 relative">
                            ...
                            <div className='w-3/4 relative'>
                                <select onChange={(e) => onHandleInput(e)} value={datas.fakultas} name="fakultas" className='w-full border-2 border-black px-2 py-1 pb-2 mt-1 rounded-md'>
                ...
                identify === "create" && (
                    <>
                        <div id='formPengabdian' className="flex p-4 mt-2 relative">
                            ...
                            <div className='w-3/4 relative'>
                                <select onChange={(e) => onHandleInput(e)} value={datas.prodi} name="prodi" className='w-full border-2 border-black px-2 py-1 pb-2 mt-1 rounded-md'>
                                    <option value={null}>pilih</option>
                                    {data.map((data) => (
                                        <>
                                            <option value={data?.id}>{data.value}</option>
                    ...
                    <>
                        <div id='formPengabdian' className="flex p-4 mt-2 relative">
                            ...
                            <div className='w-3/4 relative'>
                                ...
                                <div onChange={(e) => onHandlemitra_litabmas(e)} className={mitra_litabmas.mitraDD === true ? "z-10 absolute bg-white w-full border-2 border-t-0 border-black p-2 rounded-md rounded-t-sm" : 'hidden'}>
                                    ...
                                    <ul>
                                        {
                                            mitra_litabmas.search.length < 4 ? <label>please enter 4 or more character</label> :
                                            ...
                                            mitra_litabmas.search.length < 4 ? <label>please enter 4 or more character</label> :
                                                !filtermitra_litabmas.length ? <div className='flex w-[100%] h-[100%] text-[25px] items-center justify-center'>No Result Found!</div> :
                                                    filtermitra_litabmas.map(dataMitra => {
                                                        return <li className='skimBox border-2 border-black border-b-0 py-1 px-2' value={dataMitra.id} id='mitra' name="mitra" onClick={(i, e) => {
                                                            onHandlemitra_litabmas(i, e)
                                                            onHandleInput(e, "dosenPembimbing", dataMitra.id, dataMitra.nama)
                                                        }}>{dataMitra.nama}</li>
                                                    })
                                        }
                                    </ul>
                ...
                identify === "create" && (
                    <>
                        <div id='formPengabdian' className="flex p-4 mt-2 relative">
                            ...
                            <div className='w-3/4 relative'>
                                <select onChange={(e) => onHandleInput(e)} value={datas.FollowedProgram} name="followedProgram" className='w-full border-2 border-black px-2 py-1 pb-2 mt-1 rounded-md'>
                                    <option value={null}>pilih</option>
                                    {data.map((data) => (
                                        <>
                                            <option value={data?.id}>{data.value}</option>
                ...
                identify === "create" && (
                    <>
                        <div id='formPengabdian' className="flex p-4 mt-2 relative">
                            ...
                            <div className='w-3/4 relative bg-white'>
                                <input onChange={(e) => onHandleInput(e)} name="suratTugas" type="file" className='w-full border-2 border-black px-2 py-1 pb-2 mt-1 rounded-md' />
                            </div>
                        </div>
                    </>
                )
                ...
                identify === "create" && (
                    <>
                        <div id='formPengabdian' className="flex p-4 mt-2 relative">
                            ...
                            <div className='w-3/4 relative bg-white'>
                                <input onChange={(e) => onHandleInput(e)} name="beritaAcara" type="file" className='w-full border-2 border-black px-2 py-1 pb-2 mt-1 rounded-md' />
                            </div>
                        </div>
                    </>
                )
                ...
                identify === "detail" && (
                    <>
                        <div className="flex px-4 py-2 w-full">
                            ...
                            <div className='w-3/4'>
                                <a className="w-full" href={datas.berita_acara}>{datas.berita_acara}</a>
                            </div>
                        </div>
                    </>
                )
            ...
            <div className="flex px-4 py-2 w-full">
                ...
                <div className='flex w-3/4'>
                    ...
                    <div>
                        ...
                        <div className="mt-2">: {datas.mahasiswa?.prodi?.fakultas?.nama}</div>
