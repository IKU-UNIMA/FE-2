    ...
    axiosInstance
      .post(
        "/kampus-merdeka",
        {
          ...
          //   id_dosen_pembimbing:
          //     datas.dosenPembimbing == "" ? "" : parseInt(datas.dosenPembimbing),
          id_kategori_program:
            datas.kategoriProgram == "" ? "" : parseInt(datas.kategoriProgram),
        ...
        setErrors({
          ...
          peringkat:
            submitData.peringkat == ""
              ...
              : "",
          biaya_kuliah:
            submitData.biayaKuliah == ""
              ? err.response.data.errors.biaya_kuliah
              : "",
          //   dosen_pembimbing:
          //     submitData.dosenPembimbing == ""
          //       ? err.response.data.errors.id_dosen_pembimbing
          //       : "",
          kategori_program:
            submitData.kategoriProgram == ""
