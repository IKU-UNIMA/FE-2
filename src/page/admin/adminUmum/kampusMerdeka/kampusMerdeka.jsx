...
export default function KampusMerdekaAdminUmum() {
  ...
  const onHandleSearch = (e) => {
    ...
    axiosInstance
      .get(
        `/kampus-merdeka?nim=${filtered.nim}&prodi=${filtered.prodi}&semester=${filtered.semester}`,
        {
          "Content-Type": "application/json",
        }
      )
          ...
          .then((res) => {
            ...
            if (res.status === 200) {
              Swal.fire({
                toast: true,
                icon: "success",
                title: "Delete Data Kampus Merdeka Successfully",
                animation: false,
                background: "#222834",
                color: "#18B015",
                position: "bottom-end",
              ...
              <div className="bg-white px-4 py-4">
                ...
                <div className="flex flex-col text-left text-[16px] font-medium mt-2">
                  <div className="flex w-full text-center py-2 bg-[#2b33331a]">
                    ...
                    <div className="w-[20%]">Jenis Aktivitas</div>
                        ...
                        <>
                          <div className="flex py-2">
                            ...
                            <div className="flex justify-center px-2 w-[20%]">
                              <p className="">{data.kategori_program.nama}</p>
                            </div>
                            ...
                            <div className="flex flex-row items-start justify-center px-2 w-[15%]">
                              <div
                                ...
                                onClick={() =>
                                  navigate(
                                    `/dashboard/admin/kampus-merdeka/detail/${data.id}`
                                  )
                                }
                              >
                              ...
                              <div
                                ...
                                onClick={() =>
                                  navigate(
                                    `/dashboard/admin/kampus-merdeka/update/${data.id}`
                                  )
                                }
                              >
                              ...
                              <div
                                ...
                                onClick={(e) =>
                                  onDeleteKampusMerdeka(e, data.id)
                                }
                              >
