...
export default function AdminPrestasi() {
  ...
  const onHandleSearch = (e) => {
    ...
    axiosInstance
      .get(
        `/prestasi?nim=${filtered.nim}&prodi=${filtered.prodi}&semester=${filtered.semester}`,
        {
          "Content-Type": "application/json",
        }
      )
            ...
            <div className="p-6">
              ...
              <div className="bg-white px-4 py-4">
                ...
                <div className="flex justify-between">
                  <div className="flex justify-between w-[80%]">
                    <div className="flex flex-col w-1/3 mr-1">
                      <label className="text-[14px] font-medium tracking-[1px]">
                        NIM
                      </label>
                      <input
                        placeholder="Nim"
                        className="w-full bg-white border-2 border-black outline-none px-2 py-1 pb-2 mt-1 rounded-md"
                        type="text"
                        name="nim"
                        value={filtered.nim}
                        onChange={(e) =>
                          setFiltered({ ...filtered, nim: e.target.value })
                        }
                      />
                    </div>
                    <div className="z-20 relative w-1/3 mr-1">
                      ...
                      <div
                        ...
                        className={
                          mitra_litabmas.mitraDD === true
                            ? "z-10 flex relative justify-between border-2 border-black outline-none px-2 py-1 pb-2 rounded-t-md"
                            : "flex justify-between bg-white border-2 border-black outline-none px-2 py-1 pb-2 rounded-md"
                        }
                      >
                        {mitra_litabmas.mitra === "" ? (
                          ...
                          <>
                            <div
                              id="mitraDD"
                              className="relative inline-block truncate"
                            >
                              {mitra_litabmas.mitra}
                            </div>
                          </>
                      ...
                      <div
                        ...
                        className={
                          mitra_litabmas.mitraDD === true
                            ? "z-10 absolute bg-white w-full border-2 border-black p-2 rounded-md rounded-t-sm "
                            : "hidden"
                        }
                      >
                        <input
                          ...
                          id="search"
                          className="w-full border-2 border-black px-2 py-1 pb-2 rounded-md relative inline-block truncate"
                        />
                        <ul className="h-[200px] overflow-y-auto ">
                          {mitra_litabmas.search.length === 0 ? (
                            <label>please enter 1 or more character</label>
                    ...
                    <div className="flex flex-col w-1/3 mr-1">
                      ...
                      <select
                        onChange={(e) =>
                          setFiltered({ ...filtered, semester: e.target.value })
                        }
                        value={filtered.semester}
                        name="smester"
                        className="w-full bg-white border-2 border-black outline-none px-2 py-1 pb-2 mt-1 rounded-md"
                      >
                  ...
                  <div className="flex justify-between w-[20%]">
                    <div
                      onClick={(e) => onHandleReset(e)}
                      className="flex flex-col items-center justify-center my-auto w-full h-[100%]"
                    >
                    ...
                    <div
                      ...
                      className="flex flex-col items-center justify-center my-auto w-full h-[100%] ml-1"
                    >
                ...
                <div className="flex flex-col text-left text-[16px] font-medium mt-2">
                  <div className="flex w-full text-center py-2 bg-[#2b33331a]">
                    ...
                    <div className="w-[20%]">Tingkat Prestasi</div>
                        ...
                        <>
                          <div className="flex py-2">
                            ...
                            <div className="flex justify-center px-2 w-[20%]">
                              <p className="">{data.tingkat_prestasi}</p>
                            </div>
                            <div className="flex justify-center px-2 w-[15%]">
                              <p className="">{data.semester.nama}</p>
                            </div>
                            <div className="flex flex-row items-start justify-center px-2 w-[15%]">
                              <div
                                className="basis-1/3 mr-1 py-2 cursor-pointer rounded-md bg-green-400"
                                onClick={() =>
                                  navigate(
                                    `/dashboard/admin/prestasi/detail/${data.id}`
                                  )
                                }
                              >
                                <BsFillInfoCircleFill className="mx-auto my-auto" />
                              </div>
                              <div
                                className="basis-1/3 ml-1 mr-1 cursor-pointer py-2 rounded-md bg-yellow-500"
                                onClick={() =>
                                  navigate(
                                    `/dashboard/admin/prestasi/update/${data.id}`
                                  )
                                }
                              >
                                <BsPencilSquare className="mx-auto my-auto" />
                              </div>
                              <div
                                className="basis-1/3 ml-1 py-2 cursor-pointer rounded-md bg-red-600"
                                onClick={(e) => onDeletePrestasi(e, data.id)}
                              >
                                <BsFillTrashFill className="mx-auto my-auto" />
                              </div>
                            </div>
                          </div>
                        </>
              ...
              <div className="flex justify-between bg-white border-x-0 border-[1px] border-gray-300 py-2 px-4 ">
                  ...
                  <p class="text-sm text-gray-700">
                    ...
                    {data?.length !== 0 ? (
                      page?.page == page?.total_page ? (
                        <span class="font-medium">
                          {" "}
                          {(page?.page - 1) * page?.limit + data?.length}{" "}
                        </span>
                      ) : (
                        <span class="font-medium">
                          {" "}
                ...
                <ReactPaginate
                  ...
                  previousClassName={
                    "page-item relative inline-flex items-center rounded-l-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0"
                  }
                  nextClassName={
                    "page-item relative inline-flex items-center rounded-r-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0"
                  }
                  pageCount={page.total_page}
                  pageClassName={"my-auto text-[#2C3333]"}
                  pageLinkClassName={"hover:bg-black hover:text-white p-2"}
                  activeClassName={"bg-black text-white flex"}
