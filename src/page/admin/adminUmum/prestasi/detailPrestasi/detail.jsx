...
import { DosenPembimbing, Nama, Penyelenggara, Peringkat, Smester, StatusMahasiswa, TingkatPrestasi } from '../../../../../components/input/input';

export default function DetailPrestasiUmum() {
                            ...
                            <div>
                                ...
                                <div id='formPengabdian' className="flex p-4 mt-2 relative">
                                    ...
                                    <div className='w-3/4 relative'>
                                        ...
                                        <div className='inline-block' onClick={() => navigate(`/dashboard/admin/prestasi/${"update"}/${"sertifikat"}/${kmById.id}`)}>
