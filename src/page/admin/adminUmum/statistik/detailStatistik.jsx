        ...
        <>
            <div className='flex'>
                ...
                <div className='relative bg-[#EDE9D5] w-[83%]'>
                    ...
                    <div>
                        <div className="p-6">
                            <div onClick={(e) => navigate(-1)} className='inline-block mb-6 bg-white'>
                            ...
                            <div className='flex bg-white px-4 py-4 rounded-b-md'>
                                <div className="flex flex-col w-[100%] w-full ml-1 mr-1">
                                    ...
                                    <select onChange={(e) => setFiltered({ ...filtered, fakultas: e.target.value })} value={filtered.fakultas === "" ? detailStat : filtered.fakultas} name="tahun" className='w-full bg-white border-2 border-black outline-none border-black px-2 py-1 pb-2 mt-1 rounded-md'>
                                        {fakultas?.map((data) => (
                                            <>
                                ...
                                <div className="flex flex-col w-full ml-1 mr-1">
                                    ...
                                    <select onChange={(e) => setFiltered({ ...filtered, tahun: e.target.value })} value={filtered.tahun} name="tahun" className='w-full bg-white border-2 border-black outline-none border-black px-2 py-1 pb-2 mt-1 rounded-md'>
