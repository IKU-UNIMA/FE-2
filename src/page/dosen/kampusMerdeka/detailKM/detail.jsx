...
export default function DetailKM() {
                                    ...
                                    kmById.surat_tugas === "" ? (
                                        <div id='formPengabdian' className="flex p-4 mt-2 relative">
                                            ...
                                            <div className='w-3/4 relative'>
                                                <div className='inline-block' onClick={() => navigate(`/dashboard/kampus-merdeka/${"upload"}/${"surat-tugas"}/${kmById.id}`)}>
                                        ...
                                        <div id='formPengabdian' className="flex p-4 mt-2 relative">
                                            ...
                                            <div className='w-3/4 relative'>
                                                ...
                                                <div className='inline-block' onClick={() => navigate(`/dashboard/kampus-merdeka/${"update"}/${"surat-tugas"}/${kmById.id}`)}>
                                ...
                                }
                                {
                                    kmById.berita_acara === "" ? (
                                        <div id='formPengabdian' className="flex p-4 mt-2 relative">
                                            ...
                                            <div className='w-3/4 relative'>
                                                <div className='inline-block' onClick={() => navigate(`/dashboard/kampus-merdeka/${"upload"}/${"berita-acara"}/${kmById.id}`)}>
                                                    <PrimaryButton textButton="Upload File" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id='formPengabdian' className="flex p-4 mt-2 relative">
                                            ...
                                            <div className='w-3/4 relative'>
                                                ...
                                                <div className='inline-block' onClick={() => navigate(`/dashboard/kampus-merdeka/${"update"}/${"berita-acara"}/${kmById.id}`)}>
                                                    <SecondaryButton textButton="Update File" />
                                                </div>
                                            </div>
                                        </div>
