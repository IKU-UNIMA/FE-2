...
export default function KampusMerdeka() {
    ...
    return (
                        ...
                        <div className="p-6">
                            <div className="flex justify-between bg-white px-4 py-4 rounded-t-md border-b-[1px] border-[#2C3333]">
                                ...
                                <div className="flex justify-between">
                                    <Link to="/dashboard/kampus-merdeka/create">
                                        <div>
                            ...
                            <div className="bg-white px-4 py-4">
                                <div className="flex flex-col text-left text-[16px] font-medium mt-2">
                                    <div className="flex w-full text-center py-2 bg-[#2b33331a]">
                                        ...
                                        <div className="w-[30%]">Kategori Kegiatan</div>
                                                ...
                                                <>
                                                    <div className="flex py-2">
                                                        ...
                                                        <div className="flex flex-row items-start justify-center px-2 w-[15%]">
                                                            <div className="basis-1/3 mr-1 py-2 cursor-pointer rounded-md bg-green-400" onClick={() => navigate(`/dashboard/kampus-merdeka/detail/${data.id}`)}><BsFillInfoCircleFill className="mx-auto my-auto" /></div>
                                                            <div className="basis-1/3 ml-1 mr-1 cursor-pointer py-2 rounded-md bg-yellow-500" onClick={() => navigate(`/dashboard/kampus-merdeka/update/${data.id}`)}><BsPencilSquare className="mx-auto my-auto" /></div>
                                                            <div className="basis-1/3 ml-1 py-2 cursor-pointer rounded-md bg-red-600" onClick={(e) => onDeleteKampusMerdeka(e, data.id)}><BsFillTrashFill className="mx-auto my-auto" /></div>
                                                        </div>
                                                    </div>
                                                </>
                                            ))
        ...
        //                                 <div className="w-[30%]">KAMPUS MERDEKA</div>
